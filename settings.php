...
// Course edit prefill (from ?editid=... link, same pattern as courses.php)
$Cid = isset($_GET['editid']) ? $_GET['editid'] : '';
$Cname = isset($_GET['edit']) ? $_GET['edit'] : '';
$Cabv = isset($_GET['abv']) ? $_GET['abv'] : '';
$Ccolor = isset($_GET['color']) ? $_GET['color'] : '#6c757d';
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <form class="modal-content" method="post"
                                    ...
                                    <div class="modal-body" style="padding:30px;">
                                        ...
                                        <input type="hidden" name="Cid" id="Cid" value="<?php echo htmlspecialchars($Cid); ?>">
                                        ...
                                        <div style="margin-bottom:12px;">
                                            ...
                                            <input class="form-control"
                                                ...
                                                required
                                                onkeydown="return /[a-zA-Z]/i.test(event.key)"
                                                value="<?php echo htmlspecialchars($Cabv); ?>"
                                                style="width:100%; padding:8px; border:1px solid #ccc; border-radius:6px;"/>
                                        </div>
                                        ...
                                        <div style="margin-bottom:5px;">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <input type="color"
                                                    id="CourseColor"
                                                    name="CourseColor"
                                                    value="<?php echo htmlspecialchars($Ccolor); ?>"
                                                ...
                                                <span id="CourseColorPreview" style="width:42px;height:42px; flex-shrink:0;
                                                            background-color:<?php echo htmlspecialchars($Ccolor); ?>;
                                                            border-radius:6px;
                                                            border:1px solid #ccc;">
                                                </span>
                                            </div>
